...
if ( ! class_exists( 'Enwb_Vs_Notices' ) ) :
	...
	class Enwb_Vs_Notices {
		 ...
		 * @since 1.0.0
		 */
		private $plugin_name_dashed = ENWEBY_VARIATION_SWATCHES_FOR_WOOCOMMERCE_PLUGIN_NAME;
		 ...
		 * @since 1.0.0
		 */
		private static $version = ENWEBY_VARIATION_SWATCHES_FOR_WOOCOMMERCE_VERSION;
